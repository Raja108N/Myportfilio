  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Celery", icon: <FaLeaf className="w-4 h-4 text-green-500" /> },
        { name: "Pydantic", icon: <SiPydantic className="w-4 h-4 text-white" /> },
        { name: "PostgreSQL", icon: <SiPostgresql className="w-4 h-4 text-[#336791]" /> },
        { name: "MongoDB", icon: <SiMongodb className="w-4 h-4 text-[#47A248]" /> },
        { name: "Pytest", icon: <SiPytest className="w-4 h-4 text-yellow-400" /> },
        { name: "Jupyter", icon: <SiJupyter className="w-4 h-4 text-orange-400" /> },
        { name: "Black Formatter", icon: <BsFileEarmarkCode className="w-4 h-4 text-white" /> },
      ],
    },
    {
      icon: Cloud,
    ...
    {
      icon: Paintbrush,
      title: "Experimental & Creative Tech 🎨",
