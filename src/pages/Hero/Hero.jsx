...
const words = [
  ...
  "Loves APIs and CI/CD",
  "Linux & DevOps Explorer"
];
...
def hireable(p):
    return (
        p["hard_worker"]
        and p["problem_solver"]
        and len(p["skills"]) >= 5
        and p["years_of_experience"] >= 3
)

print("Hireable:", hireable(profile))`);
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://www.linkedin.com/in/rajababu-kushwaha-a41b69343/"
              ...
              <div className="hidden lg:block absolute top-[17rem] left-[70%] transform -translate-x-1/2 animate-float">
                <div className="px-4 py-2 rounded-lg bg-amber-500/10 backdrop-blur-sm border border-amber-500/20 text-amber-400">
                  <i className="fas fa-lightbulb"></i>&nbsp;&nbsp;Automation & Innovation
                </div>
              </div>
            </div>
